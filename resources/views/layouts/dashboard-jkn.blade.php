...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
      ...
      <div class="d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          <span class="d-none d-lg-block">DTS</span>
        </a>
      ...
      <nav class="header-nav ms-auto">
          <li class="nav-item dropdown pe-3">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
              ...
              @auth
              <li>
                <a href="{{ url('/arsip') }}" class="dropdown-item d-flex align-items-center" >
              ...
              <li>
                <a href="{{ url('/dashboard-jkn') }}" class="dropdown-item d-flex align-items-center" >
                  <i class="bi bi-house"></i>
                  <span>dashboard JKN</span>
                </a>
              </li>
              <li>
                <hr class="dropdown-divider">
 ...
 <footer id="footer" class="footer">
  <div class="copyright">
    &copy; Copyright <strong><span>Data Tracking System</span></strong>. All Rights Reserved
  </div>
  <div class="credits">
...
{{-- Dashboard --}}
<script src="{{ asset('assets/js/dashboard-jkn/index.js') }}"></script>
