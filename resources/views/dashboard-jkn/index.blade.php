           ...
           <div class="col-10">
              <div class="card recent-sales ">
                ...
                <div class="card-body">
                  ...
                  <form action="/dashboard-jkn" method="GET">
                        <div class="row">
                      <div class="col-md-3">
               ...
               <br> <br> <br><br>
                   ...
                   <div class="button-container">
                    <button type="button" class="btn btn-outline-warning btn-ajukan mb-2 " id="filter-submission-btn">
                     ...
                     <button type="button" class="btn btn-outline-secondary mb-2" id="btn-checkbox">
                     <span class="badge bg-white text-secondary">Arsip Semua</span>
                    </button> 
...
<div class="col-lg-2">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title"> Dokumen Diajukan</span></h5>

      <table class="table gy-1 align-middle table-striped px-0 history-patient">
      <thead>
      <tr class="text-gray-600 fw-bolder fs-7 text-uppercase gs-0">
      <th class="text-start" width="25%">Nama Dokumen</th>
      <th class="text-start" width="20%">Unduh</th>
      </tr>
      </thead>
      <tbody ></tbody>
      </table>
  ...
  <div class="btn-selesai-arsip">
    <button type="button" class="btn btn-success mb-4 submit-information btn-create" id="selesai-btn" data-patient-id="" data-action="Selesai">Selesai</button>
     <button type="button" class="btn btn-success mb-4 submit-information btn-create" id="arsipkan-btn" data-patient-id="" data-action="Arsip">Arsipkan</button>
   </div>  
</div>
